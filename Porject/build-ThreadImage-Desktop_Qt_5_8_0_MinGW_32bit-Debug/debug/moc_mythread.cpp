...
#include "../../ThreadImage/mythread.h"
...
QT_MOC_LITERAL(1, 9, 11), // "updataImage"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "MyThread\0updataImage\0"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updataImage((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::updataImage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::updataImage(QImage _t1)
{
