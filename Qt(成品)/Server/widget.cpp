    ...
    ui(new Ui::Widget)
{
    ...
    setWindowTitle("Tcp Server 8888");
    ...
    tcpServer->listen(QHostAddress::Any,8888);//监听8888端口
    qDebug()<<"监听8888端口";

    connect(tcpServer,&QTcpServer::newConnection,//如果客户端发送连接请求 就与客户端建立链接
            [=](){
                    qDebug()<<"与客户端建立链接";
                    qDebug()<<"取出建立好链接的套接字";
                    ...
                    connect(tcpSocket,&QTcpSocket::readyRead,
                           [=](){
                                    ...
                                    ui->textRead->setTextColor(Qt::red);
...
void Widget::on_buttonSend_clicked()
{
    ...
    ui->textRead->setTextColor(Qt::blue);
